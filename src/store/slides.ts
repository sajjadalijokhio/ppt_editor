...
export const useSlidesStore = defineStore('slides', {
  state: (): SlidesState => ({
    title: 'Unnamed presentation', // Presentation title
    theme: theme, // Theme style
    slides: slides, // Slide page data
  ...
  getters: {
    ...
    // Merge items with trigger "with previous animation" to the same position in the sequence
    // Add automatic downward execution flag to the previous item of items with trigger "after previous animation"
