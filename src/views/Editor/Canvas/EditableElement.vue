...
const contextmenus = (): ContextmenuItem[] => {
  ...
  return [
    ...
    { divider: true },
    {
      ...
      children: [
        { text: 'Horizontal & Vertical Center', handler: () => alignElementToCanvas(ElementAlignCommands.CENTER) },
        { text: 'Horizontal Center', handler: () => alignElementToCanvas(ElementAlignCommands.HORIZONTAL) },
        { text: 'Left Align', handler: () => alignElementToCanvas(ElementAlignCommands.LEFT) },
        { text: 'Right Align', handler: () => alignElementToCanvas(ElementAlignCommands.RIGHT) },
      ],
    },
    {
