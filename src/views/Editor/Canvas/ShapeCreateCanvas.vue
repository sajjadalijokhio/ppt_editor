...
onMounted(() => {
  message.success('Click to draw any shape, close the drawing by clicking again to complete, cancel by pressing ESC key or right-clicking, and complete prematurely by pressing ENTER key.', {
    duration: 0,
  })
