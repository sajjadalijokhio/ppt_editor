  ...
  <div class="export-img-dialog">
    ...
    <div class="configs">
      ...
      <div class="row" v-if="rangeType === 'custom'">
        <div class="title" :data-range="`（${range[0]} ~ ${range[1]}）`">customize scope：</div>
        <Slider
          class="config-item"
          range
          :min="1"
      ...
      <div class="row">
        ...
        <div class="config-item">
          <Switch v-model:value="ignoreWebfont" v-tooltip="'The default is Ignore online fonts when exporting. If you use online fonts in your slides and want to retain related styles after exporting, you can choose to turn off the [Ignore online fonts] option, but be aware that this will increase the export time.'" />
        </div>
      </div>
    </div>

    <div class="btns">
      <Button class="btn export" type="primary" @click="expImage()">Export pictures</Button>
