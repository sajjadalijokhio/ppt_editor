...
watch(() => slideIndex.value, () => {
  ...
  // Clear the slides in multi-select state
  if (selectedSlidesIndex.value.length) {
    mainStore.updateSelectedSlidesIndex([])
  }

  // Check whether the current page thumbnail is in the visible scope. If not, you need to scroll to the corresponding position.
  nextTick(() => {
...
const handleClickSlideThumbnail = (e: MouseEvent, index: number) => {
  ...
  // Hold down the Ctrl key and click on the slide. Click on the selected page again to deselect it.
  ...
  // Hold down the Shift key and select all slides in the scope
...
// Set the focus state of the thumbnail toolbar (the shortcut keys for this part can only take effect when the thumbnail toolbar is focused)
