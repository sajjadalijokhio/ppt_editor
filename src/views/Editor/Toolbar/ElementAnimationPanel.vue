<template>
  <div class="element-animation-panel">
    ...
    <div class="tip" v-else><IconClick style="margin-right: 5px;" /> Select the element in the canvas Add animation</div>
...
// animation选择面板打开600ms后再Remove遮罩层，否则打开面板后迅速滑入鼠标预览会导致抖动
