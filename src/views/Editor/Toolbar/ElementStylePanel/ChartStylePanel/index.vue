<template>
  <div class="chart-style-panel">
    ...
    <div class="row" v-for="(color, index) in themeColor" :key="index">
      <div style="width: 40%;">{{index === 0 ? 'Theme color matching：' : ''}}</div>
      <Popover trigger="click" style="width: 60%;">
        <template #content>
          <ColorPicker
            :modelValue="color"
    ...
    <ButtonGroup class="row" passive>
      <Popover trigger="click" v-model:open="presetThemesVisible" style="width: 40%;">
        ...
        <Button first style="width: 100%;">Recommend</Button>
      </Popover>
      <Button
        last
...
// 设置其他选项：柱状图转条形图、折line图转面积图、折line图转散点图、饼图转环形图、折line图开关平滑曲line
