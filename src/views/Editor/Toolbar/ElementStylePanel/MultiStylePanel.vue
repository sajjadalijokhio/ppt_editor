<template>
  <div class="multi-style-panel">
    ...
    >
      ...
      <RadioButton value="center" style="flex: 1;" v-tooltip="'center aligned'"><IconAlignTextCenter /></RadioButton>
      <RadioButton value="right" style="flex: 1;" v-tooltip="'right aligned'"><IconAlignTextRight /></RadioButton>
      <RadioButton value="justify" style="flex: 1;" v-tooltip="'justify aligned'"><IconAlignTextBoth /></RadioButton>
    </RadioGroup>
  </div>
</template>
...
// 批量修改fill color（表格元素为cell fill、音频元素为Icon color）
