<template>
  <div class="shape-style-panel">
    ...
    <template v-if="fillType === 'gradient'">
      ...
      <div class="row">
        <div style="width: 40%;">ending color：</div>
        <Popover trigger="click" style="width: 60%;">
          <template #content>
            <ColorPicker
    ...
    <template v-if="handleShapeElement.text?.content">
      ...
      >
        <RadioButton value="top" v-tooltip="'顶Alignment'" style="flex: 1;"><IconAlignTextTopOne /></RadioButton>
        <RadioButton value="middle" v-tooltip="'center aligned'" style="flex: 1;"><IconAlignTextMiddleOne /></RadioButton>
        <RadioButton value="bottom" v-tooltip="'底Alignment'" style="flex: 1;"><IconAlignTextBottomOne /></RadioButton>
      </RadioGroup>
