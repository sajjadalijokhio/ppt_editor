<template>
  <div class="table-style-panel">
    ...
    >
      ...
      <RadioButton value="center" v-tooltip="'center aligned'" style="flex: 1;"><IconAlignTextCenter /></RadioButton>
      <RadioButton value="right" v-tooltip="'right aligned'" style="flex: 1;"><IconAlignTextRight /></RadioButton>
      <RadioButton value="justify" v-tooltip="'justify aligned'" style="flex: 1;"><IconAlignTextBoth /></RadioButton>
    </RadioGroup>
...
// 更新表格theme ：theme 色、title line、summary row、first row、last row
